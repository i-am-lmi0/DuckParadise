questions = [
    ...
    {"id": 84, "q": "What is the primary function of webbed feet in ducks?", "options": ["Defense", "Digging", "Swimming", "Balancing"], "answer": 3},
    {"id": 85, "q": "Where do wild ducks usually nest?", "options": ["In trees", "On the ground near water", "On cliffs", "Underwater burrows"], "answer": 2},
    {"id": 86, "q": "Which duck breed is known for its distinctive white face?", "options": ["Muscovy", "Buff", "Indian Runner", "Magpie"], "answer": 1},
    {"id": 87, "q": "How do ducks cool themselves in hot weather?", "options": ["Panting", "Sweating", "Gulping water", "Shedding feathers"], "answer": 1},
    {"id": 88, "q": "Which duck is sometimes kept to control insects and weeds?", "options": ["Pekin", "Runner", "Muscovy", "Call"], "answer": 3},
    {"id": 89, "q": "What’s the name of the protective membrane over a duck's eye?", "options": ["Cornea", "Nictitating membrane", "Retina", "Duck lid"], "answer": 2},
    {"id": 90, "q": "Which continent is home to the largest number of duck species?", "options": ["Asia", "Africa", "North America", "Australia"], "answer": 1},
    {"id": 91, "q": "Why do ducks shake their feathers after preening?", "options": ["To show dominance", "To spread oils evenly", "To cool off", "To remove lice"], "answer": 2},
    {"id": 92, "q": "What’s the main difference between diving and dabbling ducks?", "options": ["Color", "Size", "Feeding behavior", "Noise level"], "answer": 3},
    {"id": 93, "q": "Which breed is often confused with geese due to their size?", "options": ["Muscovy", "Buff", "Runner", "Rouen"], "answer": 1},
    {"id": 94, "q": "What time of year do ducks typically migrate?", "options": ["Winter", "Summer", "Spring and Fall", "They don’t migrate"], "answer": 3},
    {"id": 95, "q": "Ducks have how many chambers in their heart?", "options": ["2", "3", "4", "5"], "answer": 3},
    {"id": 96, "q": "What sense is especially strong in ducks?", "options": ["Smell", "Sight", "Hearing", "Touch"], "answer": 2},
    ...
    {"id": 104, "q": "What shape are duck pupils?", "options": ["Round", "Slit", "Horizontal oval", "Vertical oval"], "answer": 3},
    {"id": 105, "q": "Which duck is known for its iridescent green head?", "options": ["Mallard", "Pekin", "Call", "Muscovy"], "answer": 1},
    {"id": 106, "q": "Which sense helps ducks find food underwater?", "options": ["Taste", "Smell", "Sight", "Touch"], "answer": 2},
    {"id": 107, "q": "What is the term for a male duck that cannot reproduce?", "options": ["Barren drake", "Ungainly drake", "Eunuch drake", "Neutered drake"], "answer": 3},
    {"id": 108, "q": "Which duck breed has legs placed farther back on the body?", "options": ["Duck", "Runner", "Call", "Muscovy"], "answer": 2},
    {"id": 109, "q": "Which duck is often used to control slugs and insects in gardens?", "options": ["Call", "Pekin", "Muscovy", "Khaki Campbell"], "answer": 3},
    {"id": 110, "q": "What is the approximate incubation time for duck eggs?", "options": ["21 days", "28 days", "35 days", "42 days"], "answer": 2},
    {"id": 111, "q": "Which duck breed has a white crescent on its face?", "options": ["Magpie", "Crested", "Rouen", "Swedish"], "answer": 1},
    {"id": 112, "q": "What is the typical color of Mallard drake’s chest?", "options": ["Brown", "Black", "White", "Blue"], "answer": 1},
    {"id": 113, "q": "Which duck type nests in cavities like trees?", "options": ["Muscovy", "Mallard", "Pekin", "Call"], "answer": 2},
    {"id": 114, "q": "How often do ducks molt feathers annually?", "options": ["Once", "Twice", "Thrice", "Never"], "answer": 1},
    {"id": 115, "q": "Which duck breed is a hybrid of Mallard and domestic ducks?", "options": ["Muscovy", "Rouen", "Swedish", "Call"], "answer": 2},
    {"id": 116, "q": "What tool helps ducks waterproof their feathers?", "options": ["Beak", "Feet", "Wing", "Preen gland"], "answer": 4},
    {"id": 117, "q": "Which duck breed is feather-footed with tufts?", "options": ["Muscovy", "Cayuga", "Silver Appleyard", "Saxon"], "answer": 4},
    {"id": 118, "q": "How do ducklings regulate their body temperature?", "options": ["Huddling with siblings", "Panting", "Bathing", "Preening"], "answer": 1},
    {"id": 119, "q": "Which duck is known for its calm temperament and often used as therapy animals?", "options": ["Call", "Pekin", "Muscovy", "Khaki Campbell"], "answer": 2},
    {"id": 120, "q": "Ducks have what type of feet?", "options": ["Clawed", "Webbed", "Scaled", "Toeless"], "answer": 2},
]